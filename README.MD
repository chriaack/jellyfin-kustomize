# Deprecated please use [helm chart](https://github.com/jellyfin/jellyfin-helm/tree/master/charts/jellyfin)

The deployment still works but not sure for how long!
